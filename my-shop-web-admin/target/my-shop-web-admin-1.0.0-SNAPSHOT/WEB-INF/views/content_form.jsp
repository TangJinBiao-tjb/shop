                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="categoryName" class="form-control required" readonly="true" data-toggle="modal" value="${tbContent.tbContentCategory.name}" data-target="#modal-default" placeholder="请选择">
                                    </div>
                                </div>
