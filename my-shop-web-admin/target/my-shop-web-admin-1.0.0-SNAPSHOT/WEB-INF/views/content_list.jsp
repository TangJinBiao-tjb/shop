...
<script>
    ...
    $(function () {
        var _columns=[
            ...
            {"data": function ( row, type, val, meta ) {
                    var datailUrl="/content/detail?id="+row.id;
                    var deleteUrl = "/content/delete";
                    return  '<button type="button" class="btn btn-sm btn-default" onclick="App.showDetail(\''+datailUrl+'\')" ><i class="fa fa-search"></i> 查看</button>&nbsp;&nbsp;&nbsp;'+
